...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/sxFQ7f1c6b)
...
```sh
npx nx serve weather-widget-fe
```

To create a production bundle:

```sh
npx nx build weather-widget-fe
```

To see all available targets to run for a project, run:

```sh
npx nx show project weather-widget-fe
```
