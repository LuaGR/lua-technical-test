...
- [X] Implementar componente de input y botón para ciudad.
- [X] Desarrollar lógica de fetch de clima y fallback de API.
- [X] Mostrar feedback visual según temperatura.
